    ...
    public static void main(String[] args) {
        try (Connection con = DriverManager.getConnection("jdbc:postgresql://localhost/postgres", "postgres", "postgres"))
        {
            ...
            do {
                ...
                switch (choice) {
                    case 1:
                        String insertQuery = "INSERT INTO programmer (pname, dob, doj, gender, prof1, prof2, salary) VALUES ('Dev', '1967-12-01', '1997-01-29', 'M', 'Pascal', 'Oracle', 4100)";
                        int rowsInserted = stmt.executeUpdate(insertQuery);
                        System.out.println("Rows inserted: " + rowsInserted);
                        break;
                    case 2:
                        String updateQuery = "UPDATE programmer SET salary = 3800 WHERE pname = 'Alice'";
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        String deleteQuery = "DELETE FROM programmer WHERE pname='Bob'";
